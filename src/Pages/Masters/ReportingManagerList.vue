                    ...
                    <div class="border rounded-lg py-7 px-8">
                        <div class="flex justify-between">
                            ...
                            <div class="flex items-center">
                                ...
                                <button class="ml-3 btn-primary-light flex items-center">
                                    ...
                                    <router-link to="/add-reporting-manager" @click="this.isSidebar = true">
                                        <span class="pl-2">
                        ...
                        <div class=" overflow-x-auto sm:rounded-lg pt-5">
                            <table class="w-full text-sm text-left text-neutral-500 ">
                                ...
                                <tbody>
                                    <tr v-for="(reportingManager,index) in reportingManagerList" :key="reportingManager._id" class="bg-white border-b">
                                        <td scope="row" class="px-6 py-4 font-medium text-neutral-700 whitespace-nowrap">
                                            #{{ index+1 }}
                                        </td>
                                        <td class="px-6 py-4">
                                            <div class="flex items-center">{{ reportingManager.name }}</div>
                                        </td>
                                        <!-- <td class="px-6 py-4">
